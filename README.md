...
| 항목 | 미국주식 (KIS, Pure Zarattini #364) | 코인 (Upbit, Option 1 #360) |
|---|---|---|
| 시장 시간 | NY 09:30~16:00 | 24/7 |
| ORB 형성 | 첫 5분봉 (09:30~09:35) | KST 22:00~23:00 (US 개장 활용) |
| 진입 룰 | **첫 봉 양봉 → 매수 / 도지 → 패스** (논문 그대로) | ORB 돌파 + VWAP + 거래량 spike |
| 진입 윈도우 | 09:35 (즉시 진입) | KST 23:00~04:00 (5h) |
| 봉 단위 | 5분봉 | 15분봉 |
| 손절 | 첫 봉 low (절대가) | OR_low 또는 -5% |
| 익절 | **10R = entry + 10×(entry−stop)** | 트레일링 -3% (수익 중) |
| EOD | NY 15:50 (마감 10분 전) | KST 11:00 (다음날) |
| 사이징 | **1% 리스크/거래** | 풀매수 |
| 종목 풀 | **SOXL/SOXS 페어** (음봉 시 인버스 매수 = 효과적 숏) | BTC/ETH/XRP/SOL/ADA/DOGE/AVAX/LINK |
...
- [x] #356 vwap_orb_breakout이 roi_table에 잘려 +0.8%에서 청산되는 버그 — 추세 진행 중 강제 매도 차단
- [x] #360 코인 ORB 22:00 / 진입 5h / EOD 11:00 (Option 1) — 백테스트 +20.63% 복리
- [x] #362 코인봇이 KIS US 보유 종목(SOXL) 잘못 잡아 OHLCV 에러 — market 필터 누락 수정
- [ ] #364 KIS US Pure Zarattini 구현 (SOXL/SOXS 페어, bar1 방향, 10R TP) — 논문 정신 회복
