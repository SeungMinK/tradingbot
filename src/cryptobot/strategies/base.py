...
class StrategyParams:
    ...
    # #222 상향: 4/1~4/20 실측 손익비 0.63(승률 67%, 평균 수익 +1.13%) → 평균 수익 확대 위해
    # 하한 올림. 기존 roi_120min=0.1은 본전치기 매도 빈발 원인.
    roi_table: dict = field(
        default_factory=lambda: {
            10: 3.5,  # 10분 내 +3.5% 이상이면 매도
            30: 2.5,  # 30분 내 +2.5%
            60: 1.8,  # 60분 내 +1.8%
            120: 1.0,  # 120분 내 실질 +1.0% 이상이면 탈출 (본전치기 방지)
        }
    )
